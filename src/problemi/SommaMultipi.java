...
public class SommaMultipi {
	...
	/**
	 * questo metodo calcola se multipo è effettivamente un multiplo di num
	 * @param multiplo
	 * @param num
	 * @return
	 */
	...
	public static void calcolaSomma(int limite,int num1,int num2)
	{
		...
		System.out.println("la somma dei multipli di "+num1+" o di "+num2+" minori di "+limite+" é "+somma);
	}
	
	
	
	
	/*	Se elenchiamo tutti i numeri naturali sotto i 10 che sono multipli di 3 o 5, otteniamo 3, 5, 6 e 9. La somma di questi multipli è 23.
